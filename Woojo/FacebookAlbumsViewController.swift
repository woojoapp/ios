...
class FacebookAlbumsViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let photoCollectionViewController = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "FacebookAlbumPhotosViewController") as! FacebookAlbumPhotosViewController
...
extension FacebookAlbumsViewController: DZNEmptyDataSetSource {
...
extension FacebookAlbumsViewController: DZNEmptyDataSetDelegate {
...
extension FacebookAlbumsViewController: ReachabilityAware {
